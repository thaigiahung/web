<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UC_insertitem.ascx.cs" Inherits="adm_UC_insertitem" %>
<style type="text/css">
    .style1
    {
        width: 100%;
    ...
    <tr>
        ...
        <td>
            ...
            &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" 
                NavigateUrl="~/adm/admin_itempage.aspx">Back</asp:HyperLink>
        </td>
    </tr>
</table>
